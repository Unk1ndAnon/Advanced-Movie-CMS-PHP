...
$query_dt=query_data("Select * from movies_database where id='$id'","UNITARY");
                    ...
                    <div class="row ml-4">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" value="'.$query_dt['title'].'"  name="Title" placeholder="Movie Title">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" value="'.$query_dt['stars'].'" class="form-control" name="Actors"
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" value="'.$query_dt['genre'].'" class="form-control" name="Genre"
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" value="'.$query_dt['release_year'].'"  class="form-control" name="Year" placeholder="Release Year">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text"value="'.$query_dt['country'].'"  class="form-control" name="Country" placeholder="Country">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" value="'.$query_dt['rated'].'"  class="form-control" name="Rated"
                              placeholder="">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" value="'.$query_dt['duration'].'"  class="form-control" name="Runtime"
                              placeholder="">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" value="'.$query_dt['director'].'"  class="form-control" name="Director"
                              placeholder="">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text"  value="'.$query_dt['writer'].'" class="form-control" name="Writer"
                              placeholder="">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text"value="'.$query_dt['language'].'"   class="form-control" name="Language"
                              placeholder="">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text"  value="'.$query_dt['votes'].'"  class="form-control" name="imdbVotes"
                              placeholder="">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" value="'.$query_dt['production'].'"  class="form-control" name="Production"
                              placeholder="">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" value="'.$query_dt['imdb_rating'].'" class="form-control" name="imdbRating"
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <textarea style="min-height:140px" class="form-control" name="Plot"
                              placeholder="Movie Description">'.$query_dt['description'].'</textarea>
                          </div>
                        </div>
                      </div>';?>
                 
                    <input type="hidden" name="type" value="movie">
                    <input type="hidden" name="uploaded_by" value="user">
                    <input type="hidden" name="Poster" value="<?php echo $query_dt['img_src']?>">
                    <input type="hidden" name="id" value="<?php echo $query_dt['id']?>">
