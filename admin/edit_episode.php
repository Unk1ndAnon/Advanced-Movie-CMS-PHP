<?php
  ...
  $query_dt=query_data("SELECT * from episodes where episode_id='$id'","UNITARY");
     ...
     <?php include('includes/header.php')?>
      ...
      <div class="main-content">
        <section class="section">
         ...
         <div class="card edit-episode">
                  <div class="card-header ">
                    <h4>Basic Details <i class="far fa-edit"></i></h4>
                  </div>
                  <div class="card-body">
                      ...
                      <div class="col-md-6">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" value="<?php echo $query_dt['season_id']?>"  name="season_id" placeholder="Season ID of Show ">
                                </div>
                                </div>
                          </div>
                          <div class="col-md-6">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control"value="<?php echo $query_dt['episode_number']?>"  name="episode_number" placeholder="i.e Episode 10">
                                </div>
                                </div>
                          </div> 
                          <div class="col-md-6">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="episode name" value="<?php echo $query_dt['episode_name']?>" placeholder="i.e Training camp from cleveland browns">
                                </div>
                                </div>
                          </div> 
                    ...
                    <div class="card-body">
                          ...
                          <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control"value="<?php echo $query_dt['vidnode_link']?>"  name="link_1" placeholder="i.e //vidcloud.icu/streaming.php?id=MjMwNjc5&amp;title=The+House+That+Jack+Built&amp;typesub=SUB&amp;sub=&amp;cover=Y292ZXIvdGhlLWhvdXNlLXRoYXQtamFjay1idWlsdC1sYXJnZS5wbmc=">
                                </div>
                          </div>
                          </div>
                          <div class="col-12 ">
                          <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="link_2" value="<?php echo $query_dt['openload_link']?>" placeholder="i.e https://streamango.com/embed/edtflndpesacaant">
                                </div>
                          </div>
                          </div>
                          <div class="col-12 ">
                          <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="link_3"value="<?php echo $query_dt['link_3']?>" placeholder="">
                                </div>
                          </div>
                          </div>
                          <div class="col-12 ">
                          <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" value="<?php echo $query_dt['download_link']?>" name="download_link" placeholder="">
                                </div>
                          </div>
                          </div>
                          <div class="col-12 ">
