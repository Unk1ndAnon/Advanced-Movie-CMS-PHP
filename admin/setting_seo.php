      ...
      <div class="main-content">
       ...
       <form action="" method="post">
                  ...
                  <div class="card-header ">
                    <h4>Movie SEO short_code:[title], [plot], [genre], [actors], [rating], [country],[slug],[year] <i class="far fa-edit"></i></h4>
                  </div>
                  ...
                  <div class="card-body ml-4">
                      ...
                      <div class="col-md-6">
                          ...
                          <div class="col-md-6">
                           ...
                           <div class="col-md-6">
                                <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">URL Structure:</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="movie_url" value="<?php echo $query_dt['movie_url']?>" >
                                </div>
                                </div>
                          </div>
                     ...
                     <div class="card-header ">
                    <h4>Tvshow SEO shortcode:[title],[season], [plot], [genre], [actors], [rating], [country],[slug],[year]  <i class="far fa-edit"></i></h4>
                  </div>
                      ...
                      <div class="col-md-6">
                           ...
                           <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <label for="inputEmail3" class="col-sm-2 col-form-label">URL Structure:</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="show_url" value="<?php echo $query_dt['show_url']?>" >
                                </div>
                                </div>
                          </div>
