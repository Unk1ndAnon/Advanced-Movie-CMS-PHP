      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="card-header mb-1">
              <h4>Mp4 Files <i class="far fa-file-video"></i></h4><b class="ml-5"> No of episodes:
              <input type="text" class="form-control ml-2 p-4" name="episodes-count" placeholder="integer value like 5" style="
    width: 199px;
    display: inline-block;
">
    

            </b><span> &nbsp * No of episodes you'd like to add</span></div>
            <div class="card-body">
              ...
              <div class="col-12 ">
                <div class="form-group row">
                  <label for="inputEmail3" class="col-sm-2 col-form-label ">720p Video (.mp4): Episode 1</label>
                  <div class="col-sm-8">
              ...
              <div class="col-12 ">
                <div class="form-group row">
                  <label for="inputEmail3" class="col-sm-2 col-form-label ">1080p Video (.mp4) :Episode 1</label>
                  <div class="col-sm-8">
              ...
              <div class="col-12 ">
                <div class="form-group row">
                  <label for="inputEmail3" class="col-sm-2 col-form-label ">English Subtitles(only .vtt) :Episode 1</label>
                  <div class="col-sm-8">
                    ...
                    <div class="row ml-4">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="Title" placeholder="Season Title">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="Season" placeholder="Season Number in integer like 5">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                      ...
                      <input type="hidden" class="form-control" name="totalSeasons" >
                      <input type="hidden" value="" class="form-control" name="list_episode" >
