    ...
    <div class="main-wrapper main-wrapper-1">
     ...
     <?php include('includes/header.php')?>
      ...
      <div class="main-content">
       ...
       <div class="card custom-css">
       <form action="" method="post">


                  <div class="card-header ">
                    <h4>Add CSS: <small> (Don't include style tag)</small></h4>
                  </div>
                  ...
                  <div class="card-body ml-4">
                      ...
                      <div class="col-md-12">
                                ...
                                <textarea id="cody" class="form-control codeeditor" name="custom_css" placeholder=""><?php echo $query_dt['custom_css']?></textarea>
                       ...
                       <input type="hidden" name="type" value="custom_css">
