...
$page=$_GET['id'];
  $query_dt=query_data("SELECT * from meta ","UNITARY");
      ...
      <div class="main-content">
       ...
       <form action="" method="post">
                  ...
                  <div class="card-header ">
                    <h4> short_code: [page],[title], [genre], [actors], [country],[year] <i class="far fa-edit"></i></h4>
                  </div>
                  ...
                  <div class="card-body ml-4">
                      ...
                      <div class="row">
                          ...
                          <div class="col-md-6">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="tit" value="<?php echo $query_dt[$page.'_tit']?>" >
                                </div>
                                </div>
                          </div>
                           ...
                           <div class="col-md-6">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="meta_tit" value="<?php echo $query_dt[$page.'_meta_tit']?>" >
                                </div>
                                </div>
                          </div>
                          ...
                          <div class="col-md-6">
                                ...
                                <div class="col-sm-9">
                                <textarea style="min-height:140px" class="form-control" name="desc" placeholder=""><?php echo $query_dt[$page.'_desc']?></textarea>
                                </div>
                                </div>
                          </div>
