...
$page_dt['latest_tit']=str_replace('[page]',$page,$page_dt['latest_tit']);
$page_dt['latest_meta_tit']=str_replace('[page]',$page,$page_dt['latest_meta_tit']);
$page_dt['latest_desc']=str_replace('[page]',$page,$page_dt['latest_desc']);
...
<head>
    ...
    <title><?php echo $page_dt['latest_meta_tit']?></title>
    <meta name="keywords" content="">

    <meta name="description" content="<?php echo $page_dt['latest_desc']?>">
    <meta name="twitter:description" content="<?php echo $page_dt['latest_desc']?>">
        ...
        <?php include('includes/header.php')?>
            ...
            <section id="content" class="inner-container content-browse">
                ...
                <?php
                   ...
                   $data = query_data("select * from movies_database where published='true' ORDER BY votes DESC limit 35");
